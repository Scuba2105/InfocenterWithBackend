...
export function CheatsheetIcon({color, size='22px'}) {
    return (
        <>
            <svg height={size} width={size} version="1.1" id="_x32_" viewBox="0 0 512 512">            
                <g>
