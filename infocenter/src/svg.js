...
export function SearchIcon({color, size='40px', mediaQueries}) {
    return (
        <>
            <svg className={mediaQueries.laptop ? "search-icon-laptop" : "search-icon-desktop"} fill={color} width={size} height={size} viewBox="0 0 1920 1920">
