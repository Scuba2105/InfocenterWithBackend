...
export function FormsTemplatesIcon({color, size='40px'}) {
    return (
        <>
            <svg fill={color} height={size} width={size} viewBox="0 0 512.001 512.001">
                <g>
                    <g>
...
export function SearchIcon({color, size='40px', searchIconClassName}) {
    return (
        <>
            <svg className={searchIconClassName} fill={color} width={size} height={size} viewBox="0 0 1920 1920">
...
export function ServiceIcon({color, size='30px'}) {
    return (
        <>
            <svg fill={color} height={size} width={size} version="1.1" id="service" viewBox="0 0 81.159 81.159">
                <g>
...
export function UserManualIcon({color, size='30px'}) {
    return (
        <>
            <svg version="1.0" id="user-manual" width={size} height={size} viewBox="0 0 64 64" enableBackground="new 0 0 64 64">
                <g>
                    <path fill={color} d="M31,7.663L2.516,0.067c-0.17-0.045-0.343-0.066-0.515-0.066c-0.437,0-0.866,0.142-1.22,0.413
                    ...
                    <path fill={color} d="M63.219,0.414c-0.354-0.271-0.784-0.413-1.221-0.413c-0.172,0-0.345,0.022-0.514,0.066L33,7.663v44.038
                    ...
                    <polygon fill={color} points="31,53.77 0,45.564 0,47.495 31,55.701 	"/>
                    <polygon fill={color} points="33,55.701 64,47.495 64,45.564 33,53.77 	"/>
                    <path fill={color} d="M35,58.034c0,1.657-1.343,3-3,3s-3-1.343-3-3c0-0.266,0.046-0.52,0.11-0.765L0,49.564v2.435
...
export function ConfigIcon({color, size='30px'}) {
    return (
        <>
            <svg fill={color} version="1.1" id="config" width={size} height={size} viewBox="0 0 93.5 93.5">
                <g>
                    <g>
...
export function SoftwareIcon({color, size='30px'}) {
    return (
        <>
            <svg fill={color} version="1.1" id="software" width={size} height={size} viewBox="0 0 256 241" enableBackground="new 0 0 256 241">
...
export function DocumentsIcon({color, size='30px'}) {
    return (
        <>
            <svg fill={color} width={size} height={size} viewBox="0 0 1024 1024"><path d="M263.508 346.359c0-11.782 9.551-21.333 21.333-21.333h303.012c11.78 0 21.333 9.551 21.333 21.333s-9.553 21.333-21.333 21.333H284.841c-11.782 0-21.333-9.551-21.333-21.333zm21.333 92.937c-11.782 0-21.333 9.553-21.333 21.333 0 11.785 9.551 21.333 21.333 21.333h303.012c11.78 0 21.333-9.549 21.333-21.333 0-11.78-9.553-21.333-21.333-21.333H284.841zm-21.333 135.599c0-11.78 9.551-21.333 21.333-21.333h303.012c11.78 0 21.333 9.553 21.333 21.333 0 11.785-9.553 21.333-21.333 21.333H284.841c-11.782 0-21.333-9.549-21.333-21.333zm21.333 92.535c-11.782 0-21.333 9.553-21.333 21.333 0 11.785 9.551 21.333 21.333 21.333h303.012c11.78 0 21.333-9.549 21.333-21.333 0-11.78-9.553-21.333-21.333-21.333H284.841z"/><path d="M325.731 43.151h15.654c1.387-.283 2.823-.432 4.294-.432s2.907.149 4.294.432H654.22c37.875 0 68.74 30.919 68.74 68.78v649.225c0 37.858-30.865 68.779-68.74 68.779H218.073c-37.873 0-68.741-30.921-68.741-68.779V212.754c0-.922.058-1.831.172-2.722.466-11.074 4.843-22.22 13.986-31.371L285.747 56.306c11.501-11.236 26.231-15.109 39.984-13.155zM193.673 208.819L315.626 86.765c.943-.899 1.808-1.238 2.577-1.366.895-.149 1.968-.049 3.028.39 1.055.437 1.833 1.1 2.312 1.78.366.52.73 1.278.803 2.512v70.051c0 .256.004.511.013.765v38.38c0 9.981-8.243 18.205-18.173 18.205H197.149c-1.328 0-2.141-.36-2.728-.777-.686-.486-1.363-1.285-1.806-2.354s-.529-2.115-.384-2.956c.124-.722.455-1.588 1.441-2.575zm173.34-123.001v3.525c.009.399.013.8.013 1.202v108.731c0 33.512-27.312 60.872-60.839 60.872L192 260.151v501.005c0 14.327 11.799 26.112 26.074 26.112h436.147c14.276 0 26.074-11.785 26.074-26.112V111.931c0-14.33-11.797-26.113-26.074-26.113H367.013z"/><path d="M777.485 128.521c-11.785 0-21.333 9.551-21.333 21.333s9.549 21.333 21.333 21.333h28.442c14.276 0 26.074 11.783 26.074 26.113v715.254c0 14.332-11.797 26.112-26.074 26.112H369.78c-14.275 0-26.074-11.785-26.074-26.112v-28.075c0-11.78-9.551-21.333-21.333-21.333s-21.333 9.553-21.333 21.333v28.075c0 37.862 30.868 68.779 68.741 68.779h436.147c37.875 0 68.74-30.916 68.74-68.779V197.3c0-37.861-30.865-68.78-68.74-68.78h-28.442z"/></svg>
        </>
    );
}

export function PadlockIcon({color, size='30px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                <path d="M8.18164 10.7027C8.18164 10.7027 8.18168 8.13513 8.18164 6.59459C8.1816 4.74571 9.70861 3 11.9998 3C14.291 3 15.8179 4.74571 15.8179 6.59459C15.8179 8.13513 15.8179 10.7027 15.8179 10.7027" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M4.50005 11.3932C4.50001 13.1319 4.49995 16.764 4.50007 19.1988C4.5002 21.8911 8.66375 22.5 12.0001 22.5C15.3364 22.5 19.5 21.8911 19.5 19.1988L19.5 11.3932C19.5 10.8409 19.0523 10.3957 18.5 10.3957H5.50004C4.94777 10.3957 4.50006 10.8409 4.50005 11.3932ZM10.5 16.0028C10.5 16.4788 10.7069 16.9065 11.0357 17.2008V18.7529C11.0357 19.3051 11.4834 19.7529 12.0357 19.7529H12.1786C12.7309 19.7529 13.1786 19.3051 13.1786 18.7529V17.2008C13.5074 16.9065 13.7143 16.4788 13.7143 16.0028C13.7143 15.1152 12.9948 14.3957 12.1072 14.3957C11.2195 14.3957 10.5 15.1152 10.5 16.0028Z" fill={color}/>
            </svg>
        </>
    )
}

export function PersonIcon({color, size='30px'}) {
    return (
        <>
            <svg fill={color} width={size} height={size} viewBox="0 0 32 32"><path d="M16 15.503A5.041 5.041 0 1 0 16 5.42a5.041 5.041 0 0 0 0 10.083zm0 2.215c-6.703 0-11 3.699-11 5.5v3.363h22v-3.363c0-2.178-4.068-5.5-11-5.5z"/></svg>  
        </>
    );
}

export function LogoutIcon({color, size='30px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M8.25 5.25L9 4.5H18L18.75 5.25V18.75L18 19.5H9L8.25 18.75V16.5H9.75V18H17.25V6H9.75V7.5H8.25V5.25Z" fill={color}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M7.06068 12.7499L14.25 12.7499L14.25 11.2499L7.06068 11.2499L8.78035 9.53027L7.71969 8.46961L4.18936 11.9999L7.71969 15.5303L8.78035 14.4696L7.06068 12.7499Z" fill={color}/>
            </svg>
        </>
    );
}

export function PasswordsIcon({color, size='30px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                <path d="M3 10V18C3 19.1046 3.89543 20 5 20H10M3 10V6C3 4.89543 3.89543 4 5 4H19C20.1046 4 21 4.89543 21 6V10M3 10H21M21 10V12" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M14 17.4286C14 16.9552 14.3838 16.5714 14.8571 16.5714H19.1429C19.6162 16.5714 20 16.9552 20 17.4286V20.1429C20 20.6162 19.6162 21 19.1429 21H14.8571C14.3838 21 14 20.6162 14 20.1429V17.4286Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M15.7143 15.2857C15.7143 14.5756 16.2899 14 17 14C17.7101 14 18.2857 14.5756 18.2857 15.2857V16.5714H15.7143V15.2857Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export function EditIcon({id, color, size='25px', onClick}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 24 24" fill="none" id={id} onClick={onClick}>
...
export function UploadIcon({color, size='25px'}) {
    return (
        <>
            <svg className="upload-icon" width={size} height={size} viewBox="0 0 24 24">
                ...
                <polyline data-name="Right" fill="none" id="Right-2" points="7.9 6.7 12 2.7 16.1 6.7" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
                <line fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="12" x2="12" y1="16.3" y2="4.8"/>
            </svg>
        </>
    );
}

export function EmailIcon({color, size='25px'}) {
    return (
        <>
            <svg height={size} width={size} viewBox="0 0 512 512">
                <g>
                    <path fill={color} d="M510.678,112.275c-2.308-11.626-7.463-22.265-14.662-31.054c-1.518-1.915-3.104-3.63-4.823-5.345
...
export function VendorArrow({size="25px", color, identifier}) {
    return (
        <>
            <svg className={identifier} fill={color} height={size} width={size} viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
...
export function NextIcon({color, size='12px', offset, angle, id}) {
    return (
        <>
            <svg id={`${id}_svg`} height={size} width={size} version="1.1" viewBox="0 0 17.804 17.804" transform={`translate(0 ${offset}) rotate(${angle})`}>
                <g id={`${id}_g1`}>
                    <g id={`${id}_g2`}>
                        <path id={`${id}_path`} d="M2.067,0.043C2.21-0.028,2.372-0.008,2.493,0.085l13.312,8.503c0.094,0.078,0.154,0.191,0.154,0.313
                            c0,0.12-0.061,0.237-0.154,0.314L2.492,17.717c-0.07,0.057-0.162,0.087-0.25,0.087l-0.176-0.04
                            c-0.136-0.065-0.222-0.207-0.222-0.361V0.402C1.844,0.25,1.93,0.107,2.067,0.043z" fill={color}/>
                    </g>
                    <g id={`${id}_g3`}>
	                </g>
                </g>
...
export function SkipIcon({color, size='20px', offset, angle, id}) {
    return (
        <>
            <svg id={`${id}_svg`}width={size} height={size} viewBox="0 0 512 512" version="1.1" transform={`translate(0 ${offset}) rotate(${angle})`}>
                <g id={`${id}_g1`} stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id={`${id}_g2`} fill={color} transform="translate(128.000000, 128.000000)">
                <polygon id={`${id}_polygon`} points="0 0 0 256 42.6666667 256 42.6666667 128.00512 256 256 256 0 42.6666667 127.989547 42.6666667 0">
                </polygon>  
                </g>
                </g>
            </svg>
...
export function Cross({color, size='12px'}) {
    return (
        <>
...
export function Tick({color, size='22px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 16 16" version="1.1" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function AuthorisationIcon({color, size='22px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                <path d="M10.49 2.23006L5.50003 4.10005C4.35003 4.53005 3.41003 5.89004 3.41003 7.12004V14.55C3.41003 15.73 4.19005 17.28 5.14005 17.99L9.44003 21.2001C10.85 22.2601 13.17 22.2601 14.58 21.2001L18.88 17.99C19.83 17.28 20.61 15.73 20.61 14.55V7.12004C20.61 5.89004 19.67 4.53005 18.52 4.10005L13.53 2.23006C12.68 1.92006 11.32 1.92006 10.49 2.23006Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12.0001 10.92C11.9601 10.92 11.9101 10.92 11.8701 10.92C10.9301 10.89 10.1801 10.11 10.1801 9.16003C10.1801 8.19003 10.9701 7.40002 11.9401 7.40002C12.9101 7.40002 13.7001 8.19003 13.7001 9.16003C13.6901 10.12 12.9401 10.89 12.0001 10.92Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10.01 13.72C9.05004 14.36 9.05004 15.41 10.01 16.05C11.1 16.78 12.89 16.78 13.98 16.05C14.94 15.41 14.94 14.36 13.98 13.72C12.9 12.99 11.11 12.99 10.01 13.72Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg> 
        </>
    );
}
...
export function MobilePhone({color, size='50px'}) {
    return (
        <>
            <svg width={size} height={size} viewBox="0 0 16 16">
                <rect width="16" height="16" id="icon-bound" fill="none" />
                <path d="M11.5,0h-7C3.675,0,3,0.675,3,1.5v13C3,15.325,3.675,16,4.5,16h7c0.825,0,1.5-0.675,1.5-1.5v-13C13,0.675,12.325,0,11.5,0z M8,15c-0.553,0-1-0.447-1-1s0.447-1,1-1s1,0.447,1,1S8.553,15,8,15z M12,12H4V2h8V12z" fill={color} />
            </svg>
        </>
    );
}
...
export function TrashCan({size="20px", color, translateX=0, translateY=0}) {
    return (
        <svg className="add-remove-image" height={size} width={size} viewBox="0 0 512 512" transform={`translate(${translateX} ${translateY})`}>
            <g>
                <path fill={color} d="M308.229,51.853C308,23.183,284.751,0.017,256,0c-28.734,0.017-52,23.183-52.228,51.853
                ...
                <path fill={color} d="M256,178.335c-89.486,0-162.024-16.841-162.024-37.625l18.53,316.253C112.506,478.506,167.233,512,256,512
...
export function NavigationArrow({size='20px', color, identifier, onClick}) {
    return (
        <svg className={`config-arrow ${identifier} form-btn-transition`} width={size} height={size} viewBox="0 0 24 24" fill="none" onClick={onClick}>
            <path fillRule="evenodd" clipRule="evenodd" d="M22.0126 2.95325C21.328 2.29971 20.2449 2.01313 19.1972 2.48035L2.68746 9.84285C0.770992 10.6975 0.770992 13.3032 2.68746 14.1579L19.1972 21.5204C20.2449 21.9876 21.328 21.701 22.0126 21.0475C22.7029 20.3884 23.0217 19.3122 22.4707 18.2802L19.3187 12.3765L18.6571 12.7298L19.3187 12.3765C19.1914 12.1381 19.1914 11.8626 19.3187 11.6242L22.4707 5.72049C23.0217 4.68853 22.7029 3.6123 22.0126 2.95325ZM20.9768 4.03821C21.2509 4.29996 21.3375 4.65823 21.1475 5.01402L21.8091 5.36725L21.1475 5.01402L17.9955 10.9177C17.6325 11.5976 17.6325 12.4031 17.9955 13.083L21.1475 18.9867C21.3375 19.3425 21.2509 19.7008 20.9768 19.9625C20.6968 20.2298 20.2563 20.3503 19.8081 20.1504L3.29838 12.7879C2.56735 12.4619 2.56735 11.5388 3.29838 11.2128L19.8081 3.8503C20.2563 3.65045 20.6968 3.77096 20.9768 4.03821Z" fill={color}/>
        </svg>
    )
}  
