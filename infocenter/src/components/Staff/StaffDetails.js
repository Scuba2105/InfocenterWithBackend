    ...
    return (
        <div className='staff-info'>
            ...
            <div className="info-container">
                {selectedData.id !== "-" && <StaffInfoEntry heading="Staff ID" value={selectedData.id} Icon={StaffID} color="#29C9BF" bColor="main"></StaffInfoEntry>}
                ...
                <StaffInfoEntry heading="Office Ph." value={selectedData.officePhone} Icon={OfficePhone} color="#29C9BF" bColor="main"></StaffInfoEntry>
                ...
                {!workshops.includes(selectedData.name) && <StaffInfoEntry heading="Mobile 1" value={selectedData.workMobile} Icon={MobilePhone} color="#29C9BF" bColor="main"></StaffInfoEntry>}
