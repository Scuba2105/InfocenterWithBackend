...
export function Tooltip({content, xPos, yPos, btnTranslateX="0px", btnTranslateY="0px", ButtonComponent, onClick, href}) {
    ...
    return (
        <div className="tooltip-button-container flex-c" style={{transform: `translate(${btnTranslateX}, ${btnTranslateY})`}}>
            ...
            <ButtonComponent onMouseOver={() => toggleHovered(setHovered)} onMouseOut={() => toggleHovered(setHovered)} onClick={onClick} href={href} ></ButtonComponent>
        </div>
    );
}
