...
export function TooltipButton({identifier, content, boolean, setAddNewType, setAddNewManufacturer, toggleFunction}) {
    ...
    return (
        <div className="tooltip-button">
            ...
            <button onMouseOut={toggleHovered} onMouseOver={toggleHovered} onClick={identifier === "type" ? () => toggleFunction(setAddNewType) : () => toggleFunction(setAddNewManufacturer) } style={boolean ? {backgroundColor: '#ff69b4'} : {backgroundColor: 'rgb(3, 252, 156)'}}>
