                            ...
                            <tbody>
                                ...
                                <tr>
                                    {bedDevices.map((device) => {
                                        return (
                                            <td key={`${device}-Bed${bedNumber}-Status`} className="tg-c3ow" onClick={() => updateTestingProgress(testingProgress, setTestingProgress, currentBedData, device)}>{currentBedData[device] ? <Tick color="rgb(5, 234, 146)"></Tick> : <Cross color="rgb(253, 67, 67)" />}</td>
                                        )
                                    })}
                                </tr>
                            </tbody>
